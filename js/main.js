...
airports = L.geoJson.ajax("assets/airports.geojson", {
  ...
  attribution: 'Airport Data &copy; Map Cruzin | US country map &copy; us states | Base Map &copy; CartoDB | Made By Kevin Ko'
}).addTo(mymap);
...
legend.onAdd = function () {
  ...
  div.innerHTML += '<i class="fa fa-signal marker-color-1"></i><p> No Control Tower </p>';
  div.innerHTML += '<i class="fa fa-signal marker-color-2"></i><p> Control tower </p>';
